...
from restart.request import WerkzeugProxyRequest
from restart.response import Response, WerkzeugProxyResponse
...
class TestResource(object):
    ...
    def make_resource(self,
        ...
        return EchoResource(proxy_request_class,
                            proxy_response_class, action_map)
    ...
    def test_make_response_with_response(self):
        rv = Response({'hello': 'world'}, 204, {'HOST': 'www.test.com'})
        resource = self.make_resource()
        response = resource.make_response(rv)
