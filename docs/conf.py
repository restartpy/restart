# -*- coding: utf-8 -*-
#
# RESTArt documentation build configuration file, created by
# sphinx-quickstart on Tue May 26 21:13:31 2015.
#
...
try:
    version = pkg_resources.get_distribution('Python-RESTArt').version
    release = version
except pkg_resources.DistributionNotFound:
    print('To build the documentation, The distribution information of '
          'RESTArt has to be available. Either install the package into '
          'your development environment or run "setup.py develop" to setup '
          'the metadata. A virtualenv is recommended!')
    sys.exit(1)
del pkg_resources
...
latex_documents = [
  (master_doc, 'RESTArt.tex', u'RESTArt Documentation',
   u'RussellLuo', 'manual'),
]
...
man_pages = [
    (master_doc, 'restart', u'RESTArt Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'RESTArt', u'RESTArt Documentation',
   author, 'RESTArt', 'One line description of project.',
   'Miscellaneous'),
]
